 ...
 */
final class Version20250421232205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE agents (id BIGSERIAL NOT NULL, data VARCHAR(255) NOT NULL, path TEXT NOT NULL, type_id SMALLINT NOT NULL, model_id BIGINT NOT NULL, asl_file_path VARCHAR(255) DEFAULT '' NOT NULL, processed BOOLEAN DEFAULT false NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE alive_agents (id BIGSERIAL NOT NULL, agent_id INT NOT NULL, model VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
